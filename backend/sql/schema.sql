...
-- ========== Unified playlists (dataset + user-created) ==========
CREATE TABLE IF NOT EXISTS playlists (
  playlist_id       TEXT PRIMARY KEY,       -- CSV: playlist_id or user-generated ID
  playlist_name     TEXT NOT NULL,
  playlist_genre    TEXT,
  playlist_subgenre TEXT,
  description       TEXT,
  user_id           INTEGER,                -- NULL for dataset playlists
...
CREATE INDEX IF NOT EXISTS idx_pl_name         ON playlists(playlist_name);
...
CREATE VIEW IF NOT EXISTS publish (album_id, artist_id) AS
